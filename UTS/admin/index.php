...
<div class="card card-primary col-lg-12">
          ...
          <?php
           ...
           <div class="card card-primary col-lg-12">
              <div class="card-header">
                <h3 class="card-title">Update Tentang</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
<div class="card card-primary col-lg-12">
              <div class="card-header">
                <h3 class="card-title">Manage Histori</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="card">
...
<div class="card card-primary col-lg-12">
              <div class="card-header">
                <h3 class="card-title">Manage Portofolio</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="card">
...
?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="http://adminlte.io">Aryadani Christian</a>.</strong>
    All rights reserved.
